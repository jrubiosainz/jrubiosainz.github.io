...
export const en = {
  ...
  portraitAlt: "Original stylized 3D portrait of Jesús, with a shaved head, dark eyebrows and a close-trimmed beard.",
  portraitCaption: "My face. A different dimension.",
...
export const es: typeof en = {
  ...
  portraitAlt: "Retrato 3D estilizado y original de Jesús, con la cabeza rapada, cejas oscuras y barba corta.",
  portraitCaption: "Mi cara. Otra dimensión.",
